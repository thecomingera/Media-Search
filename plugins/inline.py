...
async def answer(bot, query):
    ...
    if results:
        ...
        switch_pm_text = f'{emoji.CROSS_MARK} No Media Found in StreamerView Search Bot🙁'
        if string:
            switch_pm_text += f' for "{string}"'
...
def get_reply_markup(username, query):
    ...
    buttons = [
        ...
        [
           InlineKeyboardButton('Updates Channel 🗣', url='https://t.me/StreamerView'),
           InlineKeyboardButton('Rate us ★', url='https://primarchweb.blogspot.com'),
        ],
    ]
